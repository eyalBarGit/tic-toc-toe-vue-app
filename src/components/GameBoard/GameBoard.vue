...
export default {
  ...
  methods: {
    ...
    clickOnSquare(currSquare) {
      ...
      this.toggleActiveShape();
    },
    getSquare(squareId) {
      return this.getBoard[squareId];
    },
    toggleActiveShape() {
      this.activeShape === 'X' ? this.activeShape = 'O' : this.activeShape = 'X';
    },
    setSquareBorders(squareClass) {
      const squareClasses = {
        'square-0': 'border-b-2 lg:border-b-4 border-r-4 border-gray-50',
        'square-1': 'border-b-2 lg:border-b-4 border-r-4 border-gray-50',
        'square-2': 'border-b-2 lg:border-b-4 border-gray-50',
        'square-3': 'border-b-2 lg:border-b-4 border-r-4 border-gray-50',
        'square-4': 'border-b-2 lg:border-b-4 border-r-4 border-gray-50',
